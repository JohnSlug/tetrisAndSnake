\doxysection{gui/desktop/view/main.cpp File Reference}
\hypertarget{main_8cpp}{}\label{main_8cpp}\index{gui/desktop/view/main.cpp@{gui/desktop/view/main.cpp}}
...
\begin{DoxyCompactList}\small\item\em Точка входа в приложение. Создает и отображает главное окно. \end{DoxyCompactList}\end{DoxyCompactItemize}
